...
> **Development release (v2.4.1-dev):** This version is **not stable**. Preview, mask, and STL export behavior may change. Complex masks (e.g. hearts) can produce slow or very large STL exports. Use the [v2.3.0 release](https://github.com/Elusid108/LithoLab/releases) on GitHub if you need the last stable build.
