...
> **Development release (v2.4.3-dev):** This version is **not stable**. Preview, mask, and STL export behavior may change. Use the [v2.3.0 release](https://github.com/Elusid108/LithoLab/releases) on GitHub if you need the last stable build.
